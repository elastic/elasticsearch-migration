    ...
    [
      {
        ...
        docs : "https://www.elastic.co/guide/en/elasticsearch/reference/master/_setting_changes.html#_in_memory_indices",
        color : "red",
...

      {
        ...
        docs : "https://www.elastic.co/guide/en/elasticsearch/reference/master/_crud_and_routing_changes.html#_documents_must_be_specified_without_a_type_wrapper",
        color : "red",
        check : function(settings) {
...

      {
        ...
        docs : "https://www.elastic.co/guide/en/elasticsearch/reference/master/_setting_changes.html#_units_required_for_time_and_byte_sized_settings",
        color : "blue",
        check : function(settings) {
...

      {
        ...
        docs : "https://www.elastic.co/guide/en/elasticsearch/reference/master/_setting_changes.html#_merge_and_merge_throttling_settings",
        color : "blue",
        check : function(settings) {
