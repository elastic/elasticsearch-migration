== Elasticsearch Migration Helper  v2.0.0-beta1
...
[source,sh]
---------------
./bin/plugin install https://github.com/elastic/elasticsearch-migration/releases/download/v2.0.0-beta1/elasticsearch-migration-2.0.0-beta1.zip
---------------
